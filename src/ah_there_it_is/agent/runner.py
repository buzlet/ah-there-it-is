...
Фото-инструменты работают только с явно указанными непрозрачными provider/media_reference и
подписанными метаданными: не выдумывай ссылки и не утверждай, что изображено на фото.
