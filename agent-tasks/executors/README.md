...
Task and executor are selected independently. A v9 implementation handoff supplies, for example:
...
A reviewer handoff adds one immutable target line:

`Implementation: <I>`

The reviewer receives the code/tests at `I` but not the implementer's self-review,
handoff, conclusions or remaining-risk list as review input.
